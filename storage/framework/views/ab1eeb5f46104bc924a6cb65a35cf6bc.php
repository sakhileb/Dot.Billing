...
<?php endif; ?>
    ...
    <aside class="sidebar">
        <div class="sidebar-brand">
            ...
            <div>
                ...
                <div class="brand-status">
                    ...
                    <span class="brand-subtitle">Billing Intelligence</span>
                </div>
            </div>
        </div>
        ...
        <nav class="sidebar-nav">
            ...
            <a href="<?php echo e(route('profile.show')); ?>" class="nav-item <?php echo e(request()->routeIs('profile.show') ? 'active' : ''); ?>">
        ...
        <div class="sidebar-footer">
            <div class="user-row">
                ...
                <div style="min-width:0;flex:1;">
                    ...
                    <div class="user-team"><?php echo e(Auth::user()->currentTeam->name ?? 'Personal'); ?></div>
                </div>
            </div>
        </div>
    ...
    <header class="topbar">
        <div class="topbar-title">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($header)): ?><?php echo e($header); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
        <span class="topbar-team"><?php echo e(Auth::user()->currentTeam->name ?? 'Personal'); ?></span>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <a href="<?php echo e(route('profile.show')); ?>" class="topbar-btn" title="Profile">
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2980912838-0', $__key);
...
<?php /**PATH /workspaces/Dot.Billing/resources/views/layouts/app.blade.php ENDPATH**/ ?>