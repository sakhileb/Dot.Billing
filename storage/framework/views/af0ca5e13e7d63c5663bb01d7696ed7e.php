...
<?php endif; ?>
            ...
            <div class="flex items-center mt-2">
                ...
                <div class="ms-4 leading-tight">
                    <div class="text-gray-900 dark:text-white"><?php echo e($team->owner->name); ?></div>
                    <div class="text-gray-700 dark:text-gray-300 text-sm"><?php echo e($team->owner->email); ?></div>
                </div>
            </div>
        </div>
...
<?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Gate::check('update', $team)): ?>
...
<?php endif; ?>
<?php /**PATH /workspaces/Dot.Billing/resources/views/teams/update-team-name-form.blade.php ENDPATH**/ ?>